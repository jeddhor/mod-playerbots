...
public:
    TriggerContext()
    {
        ...
        creators["fish status"] = &TriggerContext::fish_status;
        creators["craft goal status"] = &TriggerContext::craft_goal_status;
...
private:
    ...
    static Trigger* fish_status(PlayerbotAI* botAI) { return new NewRpgStatusTrigger(botAI, RPG_FISH); }
    static Trigger* craft_goal_status(PlayerbotAI* botAI) { return new NewRpgStatusTrigger(botAI, RPG_CRAFT_GOAL); }
